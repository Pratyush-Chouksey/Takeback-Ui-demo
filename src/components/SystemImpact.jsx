...
export function SystemImpact() {
  ...
  return (
    <section 
      id="system-impact-section"
      className="relative min-h-screen w-full bg-[#0B0F12] text-light-cream border-t border-white/5"
    >
      ...
      <div className="max-w-[1440px] mx-auto px-5 lg:px-20 py-16 md:py-24 flex flex-col gap-16 md:gap-24">
        ...
        <div className="flex flex-col gap-2 max-w-xl">
          <span className="text-xs font-mono tracking-[0.2em] text-mint uppercase font-semibold">
            CHAPTER 6 // REALTIME DATA METRIC MATRIX
          </span>
        ...
        <div 
          ...
          aria-live="polite"
          data-aria-live-config="policied"
        >
          {/* Metric Cell 1 */}
          <div className="p-6 md:p-8 rounded-2xl bg-[#1E252B] border border-white/5 flex flex-col gap-3 relative overflow-hidden">
            ...
            <div className="h-12 overflow-hidden flex items-center">
              <span 
                ...
                style={{ animation: 'slideUpDigit 0.35s var(--transition-spring) forwards' }}
              >
                {formatCups(cups)}
              </span>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 lg:items-center">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div 
                ...
                style={{ animation: 'springScaleCalc 0.5s var(--transition-spring) forwards' }}
              >
